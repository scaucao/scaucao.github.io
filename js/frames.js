...
function frames(variable){
    ...
    if (variable==1){
        ...
        document.getElementById("enframe").height="720";
    }
    else if (variable==3){
        document.getElementById("enframe").src="pages/projects.html";
        document.getElementById("enframe").height="660";
    }
    else if (variable==4){
        document.getElementById("enframe").src="pages/publications.html";
        document.getElementById("enframe").height="3090";
    }
    else if (variable==5){
        ...
        document.getElementById("enframe").height="1080";
    }  
    else if (variable==8){
        ...
        document.getElementById("enframe").height="760";
    } 
} 
